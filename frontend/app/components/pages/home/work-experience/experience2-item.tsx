...
export const ExperienceItem2 = () => {
  const techBadges = ['React.js', 'SQL', 'TypeORM', 'Node.js', 'Tailwind'];
      ...
      <div>
        <div className="flex flex-col gap-2 text-sm sm:text-base">
          ...
          <p className="text-gray-400">
            Colaboração no desenvolvimento do sistema EXA, voltado para clínicas
            privadas, utilizando NodeJS e ReactJS. Colaboração na manutenção do
            sistema e na implementação de novos menus utilizando TypeScript.
          </p>
        </div>
