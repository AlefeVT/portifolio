...
export default function Navbar() {
  ...
  return (
    <nav className="border-b border-gray-200 dark:border-gray-700 w-full">
      <div>
        <nav>
            ...
            <div className="flex items-center justify-between h-20">
              <div className="flex items-center space-x-8">
                ...
                <label className="flex cursor-pointer relative">
                  ...
                  />
                  <div
                    className="peer after:bg-[length:12px_12px] after:bg-no-repeat after:bg-center after:bg-[url('/moon.svg')] 
              ...
              <div className="hidden md:block">
                <div className="ml-4 flex items-center space-x-4">
                  <a
                    href="#about-section"
                    className="text-black dark:text-white hover:bg-zinc-200 dark:hover:bg-zinc-800 rounded-lg p-2"
                  >
                    {t('a1')}
                  </a>
                  <a
              ...
              <div className="md:hidden flex items-center">
                <button
                  className="inline-flex items-center justify-center p-2 rounded-md text-black dark:text-white hover:text-black dark:hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white"
